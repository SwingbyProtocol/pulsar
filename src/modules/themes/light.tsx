...
export const pulsarLightColors = css`
  ...
  --sbpulsar-color-text-normal: var(--sbpulsar-color-text-light-bg-normal);
  --sbpulsar-color-text-masked: var(--sbpulsar-color-text-light-bg-masked);
  --sbpulsar-color-text-accent: var(--sbpulsar-color-text-light-bg-accent);
